(function($) {
  'use strict';
  $(function() {
    if ($("#3performanceLine").length) {
      const ctx = document.getElementById('3performanceLine');
      var graphGradient = document.getElementById("3performanceLine").getContext('2d');
      var graphGradient2 = document.getElementById("3performanceLine").getContext('2d');
      var graphGradient3 = document.getElementById("3performanceLine").getContext('2d');
      var graphGradient4 = document.getElementById("3performanceLine").getContext('2d');
      var graphGradient5 = document.getElementById("3performanceLine").getContext('2d');
    ...
    if ($("#3marketingOverview").length) {
        const marketingOverviewCanvas = document.getElementById('3marketingOverview');
...
if ($("#3doughnutChart").length) {
  const doughnutChartCanvas = document.getElementById('3doughnutChart');
