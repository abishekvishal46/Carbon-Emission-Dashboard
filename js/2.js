(function($) {
  'use strict';
  $(function() {
    if ($("#2performanceLine").length) {
      const ctx = document.getElementById('2performanceLine');
      var graphGradient = document.getElementById("2performanceLine").getContext('2d');
      var graphGradient2 = document.getElementById("2performanceLine").getContext('2d');
      var graphGradient3 = document.getElementById("2performanceLine").getContext('2d');
      var graphGradient4 = document.getElementById("2performanceLine").getContext('2d');
      var graphGradient5 = document.getElementById("2performanceLine").getContext('2d');
    ...
    if ($("#2marketingOverview").length) {
        const marketingOverviewCanvas = document.getElementById('2marketingOverview');
...
if ($("#2doughnutChart").length) {
  const doughnutChartCanvas = document.getElementById('2doughnutChart');
