(function($) {
  ...
  $(function() {
    if ($("#performanceLine").length) {
      ...
      var graphGradient3 = document.getElementById("performanceLine").getContext('2d');
      var graphGradient4 = document.getElementById("performanceLine").getContext('2d');
      var graphGradient5 = document.getElementById("performanceLine").getContext('2d');
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'CO',
                        data: [50, 210, 160, 290, 100, 315, 30, 470, 190, 210, 240, 180],
                    ...
                    {
                        label: 'NO2',
                        data: [20, 250, 90, 450, 320, 150, 430, 120, 230, 152, 400, 195],
